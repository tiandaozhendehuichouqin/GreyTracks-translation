...
// 预期: 5d41402abc4b2a76b9719d911017c592

// 测试用例3: "test"
console.log('MD5("test"):', md5('test'));
// 预期: 098f6bcd4621d373cade4e832627b4f6

// 测试用例4: 中文
console.log('MD5("你好"):', md5('你好'));
// 预期: 7e240de74fb1ed08fa08d38063f6a6a9

// 测试百度翻译签名
const appid = '20240101001968151'; // 示例APP ID
const text = 'test'; // 示例文本
const salt = 123456; // 示例salt
const apiKey = 'test_key'; // 示例API Key

const signStr = appid + text + salt + apiKey;
console.log('Sign string:', signStr);
console.log('MD5 sign:', md5(signStr));
